...
# ACDS 22.1 915 linux 2022.12.14.09:10:33
# ----------------------------------------
...
# ----------------------------------------
# If gen_pll is one of several IP cores in your
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/dev/astasiak/cad/intel/fpga/lite/22.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/gen_pll.vo"
}
