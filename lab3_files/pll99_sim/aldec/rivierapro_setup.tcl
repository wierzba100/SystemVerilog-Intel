...
# ACDS 21.1 850 win32 2022.12.14.22:21:44
# ----------------------------------------
...
# ----------------------------------------
# If pll99 is one of several IP cores in your
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/intel/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll99.vo"
}
